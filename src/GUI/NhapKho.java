...
public class NhapKho extends javax.swing.JPanel {
    ...
    CTNhapKhoBUS cTNhapKhoBUS = new CTNhapKhoBUS();
    ArrayList<CTNhapKhoDTO> listCTNhapKho = cTNhapKhoBUS.getAllCTNhapKhoDTO();
    DefaultTableModel dtmgio;
    
    
    public NhapKho(int quyen) {
        initComponents();
        ...
        tblCTPhieuNhap.setFocusable(false);
        tblCTPhieuNhap.setDefaultEditor(Object.class, null); // set ko cho sửa dữ liệu trên table
        tblCTPhieuNhap.getColumnModel().getColumn(1).setPreferredWidth(180);
        tblCTPhieuNhap.setAutoCreateRowSorter(true);
        ...
        hienThiCTNhapKho(listCTNhapKho);
    ...
    public void hienThiCTNhapKho(ArrayList<CTNhapKhoDTO> listCTNhapKho){
        DefaultTableModel dtm = (DefaultTableModel) tblCTPhieuNhap.getModel();
        dtm.setRowCount(0);
        for(CTNhapKhoDTO cTNhapKhoDTO : listCTNhapKho){
            String tien = convertToVND(cTNhapKhoDTO.getThanhtien());
            Object[] row = {
                cTNhapKhoDTO.getMaphieunhap(),
                cTNhapKhoDTO.getMasp(),
                cTNhapKhoDTO.getSoluong(),
                cTNhapKhoDTO.getDongia(),
                tien,
            };
            dtm.addRow(row);
        }
        ...
        // Áp dụng renderer cho từng cột trong bảng
        for (int i = 0; i < tblCTPhieuNhap.getColumnCount(); i++) {
    ...
    private void initComponents() {
        ...
        txtTGPN = new javax.swing.JTextField();
        ...
        jLabel2.setText("DANH SÁCH HÀNG NHẬP");
                    ...
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btnchonNCC, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        .addGap(34, 34, 34)
                        .addComponent(btnXoaHang, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(35, 35, 35)
        ...
        txtMPN.setEditable(false);

        jLabel16.setText("Thời gian");

        txtTGPN.setEditable(false);

        jLabel17.setText("Nhà cung cấp");

        txtNCCPN.setEditable(false);
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addComponent(txtMPN, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtTGPN, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel15Layout.setVerticalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel16)
                    .addComponent(txtTGPN, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel17)
                    .addComponent(txtNCCPN, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel18)
        ...
        jLabel14.setText("Thông tin chi tiết phiếu nhập");
    ...
    private void tblPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPhieuNhapMouseClicked
        ...
        if(tblPhieuNhap.getSelectedRow()!=-1){
            ...
            NhapKhoDTO nhapKhoDTO = nhapKhoBUS.getNhapKho(mapn);
            txtMPN.setText(nhapKhoDTO.getMaphieunhap()+"");
            txtTGPN.setText(nhapKhoDTO.getThoigian()+"");
            
            NhaCungCapBUS nhaCungCapBUS = new NhaCungCapBUS();
            NhaCungCapDTO nhaCungCapDTO = nhaCungCapBUS.selectByID(nhapKhoDTO.getManhacungcap());
            txtNCCPN.setText(nhaCungCapDTO.getTenNhaCungCap());
            
            NhanVienBUS nhanVienBUS = new NhanVienBUS();
            NhanVienDTO nhanVienDTO = nhanVienBUS.selectByID(nhapKhoDTO.getManv());
            txtNVPN.setText(nhanVienDTO.getHoten());
            
            String tien = convertToVND(nhapKhoDTO.getTongtien());
            txtTTPN.setText(tien);
            
            ArrayList<CTNhapKhoDTO> listCTNhapKhotheomapn = cTNhapKhoBUS.getCTNhapKho(mapn);
            hienThiCTNhapKho(listCTNhapKhotheomapn);
        }
    }//GEN-LAST:event_tblPhieuNhapMouseClicked

    private void tblCTPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCTPhieuNhapMouseClicked
        // TODO add your handling code here:
        if(tblCTPhieuNhap.getSelectedRow()!=-1){
            int row = tblCTPhieuNhap.getSelectedRow();
            TableModel model = tblCTPhieuNhap.getModel();
            int mapn = Integer.parseInt(model.getValueAt(row, 0).toString());
            int masp = Integer.parseInt(model.getValueAt(row, 1).toString());
            
            CTNhapKhoDTO cTNhapKhoDTO = cTNhapKhoBUS.getCTNhapKhompnmsp(mapn, masp);
            
            txtCTMPN.setText(cTNhapKhoDTO.getMaphieunhap()+"");
            txtMSPCTPN.setText(cTNhapKhoDTO.getMasp()+"");
            txtSLCTPN.setText(cTNhapKhoDTO.getSoluong()+"");
            txtDGCTPN.setText(convertToVND(cTNhapKhoDTO.getDongia()));
            txtTTCTPN.setText(convertToVND(cTNhapKhoDTO.getThanhtien()));
        }
    ...
    private void btnchonNCCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnchonNCCActionPerformed
        // TODO add your handling code here:
        showNCCap show = new showNCCap();
        show.setVisible(true);
        if(show.getNhaCungCapChon()!=null){
            txtNCC.setText(show.getNhaCungCapChon().getMaNhaCungCap()+" - "+show.getNhaCungCapChon().getTenNhaCungCap());
        } else txtNCC.setText("");
    ...
    private void btnThemVaoGioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemVaoGioActionPerformed
        ...
        int row = tblSanPham.getSelectedRow();
        if(row!=-1){
            if(txtGiaNhap.getText().trim().equals("") || txtSoLuong.getText().trim().equals("") || txtGiaNhap.getText().trim().equals("0") || txtSoLuong.getText().trim().equals("0")){
                JOptionPane.showMessageDialog(this, "Vui lòng nhập đủ giá nhập và số lượng", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            if(!isInteger(txtGiaNhap.getText()) || !isInteger(txtSoLuong.getText())){
                JOptionPane.showMessageDialog(this, "Giá nhập và số lượng phải là số nguyên", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        if(txtNCC.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Chưa chọn nhà cung cấp", "Lỗi", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        ArrayList<CTNhapKhoDTO> dsct = new ArrayList<>();
        ...
        for (int i = 0; i < row; i++) {
            ...
            CTNhapKhoDTO ctpn = new CTNhapKhoDTO(0, maSP, soLuong, donGia, thanhTien);
            dsct.add(ctpn);
        }
        String str = txtNCC.getText();
        ...
        XuatPhieuNhap xuatPhieuNhap = new XuatPhieuNhap(ncc, nhanVien, dsct);
        xuatPhieuNhap.setVisible(true);
        if (xuatPhieuNhap.getCheckNhap()) {
            dtmgio.setRowCount(0);
            listSanPhamGioHang = sanPhamBUS.getAllSanPham();
            hienThiSanPham(listSanPham);
        }
    ...
    private javax.swing.JTextField txtTGPN;
