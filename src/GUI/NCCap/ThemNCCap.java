...
public class ThemNCCap extends javax.swing.JFrame {
    ...
    public NhaCungCapDTO getThongTinNCC (){
        String tenNcc = txtTenNhaCungCap.getText();
        String diaChi = txtDiaChi.getText();
        String email = txtEmail.getText();
        String sdt = txtSoDienThoai.getText();
        nhaCungCapDTO = new NhaCungCapDTO(tenNcc, diaChi, email, sdt);
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLuuActionPerformed
        ...
        if(txtTenNhaCungCap.getText().equals("") || txtDiaChi.getText().equals("") || txtEmail.getText().equals("")  || txtSoDienThoai.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Vui lòng nhập đầy đủ thông tin");
        } else {
            nhaCungCapDTO = getThongTinNCC();
            NhaCungCapBUS nhaCungCapBUS = new NhaCungCapBUS();
            boolean thanhCong = nhaCungCapBUS.addNhaCungCap(nhaCungCapDTO);
            if(thanhCong){
                JOptionPane.showMessageDialog(null, "Thêm nhà cung cấp thành công", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                dispose(); 
            } else {
                JOptionPane.showMessageDialog(null, "Thêm nhà cung cấp thất bại", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            }
        }
